...
<table cellspacing=1 cellpadding=1 width='98%' style="border-top: #000000 1px solid;border-left: #000000 1px solid;border-right: #000000 1px solid;" align=center>
  ...
  <?php
		...
		foreach($readdb as $read) {
			...
			$table_id=$td_id=$a_id='';
	?>
	<table cellspacing=1 cellpadding=0 width='98%' style='TABLE-LAYOUT: fixed;WORD-WRAP: break-word;' class=i_table align=center>
    <tr>
      <td height="100%" valign=top width='20%' bgcolor='#E8E8E8' style='padding: 5px;'><font color=#000066><b><?=$read['author']?></b></font><br>
      ...
      <td width='80%' height="100%" bgcolor='#E8E8E8' valign=top><table width='99%' height="100%" align=center cellspacing=0 cellpadding=4 style='TABLE-LAYOUT: fixed;WORD-WRAP: break-word' >
          <tr>
            <td bgcolor="#E8E8E8" colspan="6" valign="top" >
          ...
          <tr valign=bottom bgcolor='#E8E8E8'>
            <td colspan=6></td>
          </tr>
          ...
          <tr bgcolor="#E8E8E8" valign=bottom>
