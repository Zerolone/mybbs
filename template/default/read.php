...
<table cellspacing=0 cellpadding=1 width='98%' style="border-top: #E7E3E7 1px solid;border-left: #E7E3E7 1px solid;border-right: #E7E3E7 1px solid;" align=center>
  ...
  <table cellspacing=1 cellpadding=0 width='98%' style='TABLE-LAYOUT: fixed;WORD-WRAP: break-word;' bgcolor=#E7E3E7 align=center>
    <tr>
      <td height="100%" valign=top width='20%' bgcolor='#FFFFFF' style='padding: 5px;'><font color=#000066><b><?=$read['author']?></b></font><br>
      ...
      <td width='80%' height="100%" bgcolor='#FFFFFF' valign=top><table width='99%' height="100%" align=center cellspacing=0 cellpadding=4 style='TABLE-LAYOUT: fixed;WORD-WRAP: break-word' >
          <tr>
...
<form name="FORM" method="post" action="post.php?" enctype="multipart/form-data"  onSubmit="return checkCnt();">
  <table cellspacing=1 cellpadding=0 align=center width="98%" bgcolor=#E7E3E7>
    ...
    <tr>
      <td valign=top width=20% bgcolor=#FFFFFF style="padding:7px"><b>内容</b></td>
      <td width=80% bgcolor=#FFFFFF style="padding:7px"> 标题:
