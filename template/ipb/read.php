...
<table cellspacing=0 cellpadding=1 width='100%' style="border-top: #003366 1px solid;border-left: #003366 1px solid;border-right: #003366 1px solid;" align=center>
  <tr>
  ...
  <?php
		...
		foreach($readdb as $read) {
			...
			$table_id=$td_id=$a_id='';
	?>
	<table cellspacing=1 cellpadding=0 width='100%' style='TABLE-LAYOUT: fixed;WORD-WRAP: break-word;' class=i_table align=center>
    <tr>
      <td height="100%" valign=top width='20%' bgcolor='#DFE6EF' style='padding: 5px;'><font color=#000066><b><?=$read['author']?></b></font><br>
      ...
      <td width='80%' height="100%" bgcolor='#DFE6EF' valign=top><table width='99%' height="100%" align=center cellspacing=0 cellpadding=4 style='TABLE-LAYOUT: fixed;WORD-WRAP: break-word' >
          <tr>
            <td bgcolor="#DFE6EF" colspan="6" valign="top" >
          ...
          <tr valign=bottom bgcolor='#DFE6EF'>
            <td colspan=6></td>
          </tr>
          ...
          <tr bgcolor="#DFE6EF" valign=bottom>
...
<form name="FORM" method="post" action="post.php?" enctype="multipart/form-data"  onSubmit="return checkCnt();">
	<table cellspacing=1 cellpadding=0 align=center width="100%" class=i_table>
    <tr>
    ...
    <tr>
      <td valign=top width=20% bgcolor=#E4EAF2 style="padding:7px"><b>内容</b></td>
      <td width=80% bgcolor=#E4EAF2 style="padding:7px"> 标题:
