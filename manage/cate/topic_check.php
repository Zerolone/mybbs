 ...
 * 帖子审核
 * 
 * @version 2010-3-19 15:19:20
 * @author Zerolone
*/
require('../include/common.php');
define('PAGE_NAME','topic_check.php');

//计算未审核的帖数
$count=0;
$SqlStr='SELECT COUNT(*) as `count` FROM `'.DB_TABLE_PRE.'topics` WHERE `ifcheck`=0;';
//	DebugStr($str_Sql);
...
$SqlStr='SELECT * FROM `'.DB_TABLE_PRE.'view_topic` WHERE ' . $sql . ' ORDER BY ' . $orderway . $limit2;
//	DebugStr($str_Sql);
$MyDatabase->SqlStr = $SqlStr;
if ($MyDatabase->Query ()) {
