...
<body>
<form name="topic_check" method="post" action="post_check_update.php">
<!-- 论坛循环 -->
<table cellspacing=1 cellpadding=5 width='100%' bgcolor=#E7E3E7 align=center>
  <tr>
    ...
    <td align=left class=head><input name="s_list_post" type="submit" value="更新回复并审核" id="s_list_post"></td>
