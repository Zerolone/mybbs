...
<div class="div100">
      ...
      <input name="s_list_order" id="s_list_order" type="submit" class="inputbox" value="修改顺序">
      <input name="s_list_del" type="submit" class="inputbox" onClick="return confirm('你真的要删除所选信息？！');" value=" 删 除 ">
      <input name="selectall" type="button" class="inputbox" id="selectall" onclick='selectall()' value=" 全 选 ">
      ...
      -->
			...
			<a href="?cateid=<?=$cateid?>&pagesize=<?=($pagesize*2)?>">2倍排序</a>
<input name="s_move" 			type="submit" class="inputbox" value="移动到-&gt;" onClick="return confirm('确定移动文章？');"><select name="changecateid" class="inputbox" id="changecateid" style="width:180px">
          <?php
					if(isset($cate_list))
					{
