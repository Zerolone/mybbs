...
//	alert(pagenum);
  ...
  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC" id="DBList">
    <tr height="26">
      <td height="26" colspan="7" bgcolor="#666666"><b><font color="#FFFFFF">&nbsp;导航菜单管理 &gt;&gt; 可提供服务</font></b></td>
    </tr>
    <tr valign=center align=middle>
      <td width="25" bgcolor=#999999 height=20><p><font color="#FFFFFF">顺序</font></p></td>
  ...
  <form name="form1" action="navservice_update.php" method="post">
		<?php
    ...
    <tr>
      ...
      <td>&nbsp;<a href="navservice_edit.php?id=<?=$navbar['id']?>&pid=<?=$pid?>">修改</a></td>
    </tr>
    </label>
    <?php
				}
		...
		?>
    <tr>
      <td valign=bottom height=20 colspan="7" align=right><a href="navservice_add.php?pid=<?=$pid?>">添加一个服务</a> <a href="nav.php">返回列表</a>
