...
<tr bgcolor="#6A6A6A">
    <td colspan="2" height="26"><b><font color="#FFFFFF">&nbsp;在线咨询管理 &gt;&gt; 在线咨询操作</font></b></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<tr>
	  <td width="100" height="20" align="right" bgcolor="#999999"><font color="#FFFFFF">内　　容：</font></td>
	  <td bgcolor="#FFFFFF"><textarea name="content" cols="80" rows="7" class="InputBox" id="content" style="width:300"><?=$content?></textarea></td>
	  </tr>	  
  <tr>
