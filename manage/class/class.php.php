...
<tr bgcolor="#6A6A6A">
    <td colspan="11" height="26"><b><font color="#FFFFFF">&nbsp;课程管理 &gt;&gt; 课程列表</font></b></td>
  </tr>
    <tr valign=center align=middle>
      ...
      <td width="60" bgcolor=#999999><font color="#FFFFFF">主讲老师</font></td>
      <td width="50" bgcolor=#999999><font color="#FFFFFF">学习模块</font></td>
  ...
  <form name="form1" action="update.php" method="post">
    ...
    <tr>
      ...
      <td>&nbsp;<?=$ad['title']?></td>
      <td>&nbsp;<?=$ad['teacher']?></td>
      <td>&nbsp;<a href="class_detail.php?parentid=<?=$ad['id']?>&pagenum=<?=$pagenum?>">查看模块</a></td>
