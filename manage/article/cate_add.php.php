...
<tr bgcolor="#6A6A6A">
    <td colspan="10" height="26"><b><font color="#FFFFFF">&nbsp;文章分类管理 &gt;&gt; 文章分类操作</font></b></td>
  </tr>  
    <tr>
    ...
    <tr>
      <td align="right" width="100" bgcolor="#999999" height="20"><font color="#FFFFFF">分类地址：</font></td>
      <td bgcolor="#FFFFFF"><input name="url" type="text" class="inputbox" id="url" onMouseOver="select();" value="<?=$url?>" size="40" maxlength="150" /> 
        默认不需要填写</td>
    </tr>	    
    <tr>
