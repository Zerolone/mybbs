...
<table id="tb" cellspacing="0" cellpadding="0" width="490" border="0" name="tb" style="border: 1px solid #C0C0C0">
	<tr>
		<td>
		<form name="form1" method="post" action="upfile1.php" target="AAA" enctype="multipart/form-data" style="MARGIN-BOTTOM:0px">
			<input type="hidden" name="act" value="upload"><table border="0" cellspacing="0" cellpadding="0">
				...
				<tr align="center" valign="middle">
					...
					<input type="hidden" value="" name="UpLoadPic">
					<input type="hidden" value="0" name="watermark">
					<input type="button" name="InsertUpLoadPic" style="display:none;" value=" 添加图片到编辑器 " class="InputBox" id="Ok2">
					</td>
				</tr>
			</table>
		</form>
