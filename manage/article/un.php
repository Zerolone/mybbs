...
$SqlStr = 'Select count(*) from `'.table_pre.'article` Where  `cateid`='.$cateid.' and `flag`=0';
$temp_query 	= query($SqlStr);
...
//------------------0------1---------2----------3------4
$SqlStr	= 'SELECT `id`, `title`, `posttime`, `flag`, `url` from '.table_pre.'article WHERE `flag`=0 and `cateid`='.$cateid;
